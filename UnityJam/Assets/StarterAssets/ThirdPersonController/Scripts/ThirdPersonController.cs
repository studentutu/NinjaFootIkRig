...
namespace StarterAssets
{
    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        [Tooltip("The size of the grounded box check.")]
        public Vector3 GroundBoxCheckSize = Vector3.one * 0.28f;
        ...
        private void GroundedCheck()
        {
            ...
            Vector3 spherePosition = new Vector3(position.x, position.y - GroundedOffset,
                position.z);
            Grounded = Physics.CheckBox(spherePosition, GroundBoxCheckSize*0.5f,Quaternion.identity,GroundLayers,
